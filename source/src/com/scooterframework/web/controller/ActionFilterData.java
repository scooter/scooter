...
public class ActionFilterData
{
    ...
    public ActionFilterData(Class filterClz, String type, String option, String filters, String actions) {
        ...
        this.option = option;
        if (option != null && 
            !ActionControl.FILTER_OPTION_ONLY.equals(option) &&
            !ActionControl.FILTER_OPTION_EXCEPT.equals(option)) { 
    ...
    private boolean isOnly() {
        return ActionControl.FILTER_OPTION_ONLY.equals(option);
    }
    
    private boolean isExcept() {
        return ActionControl.FILTER_OPTION_EXCEPT.equals(option);
    }
