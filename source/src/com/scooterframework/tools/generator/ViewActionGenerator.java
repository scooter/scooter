...
public class ViewActionGenerator extends AbstractGenerator {
	...
	public ViewActionGenerator(String templateFilePath, Properties props, String controller, String action) {
	...
	protected Properties getTemplateProperties() {
		...
		templateProps.setProperty("view_path", relativePathToView);
		templateProps.setProperty("view_file", viewFileName);
