...
<p>
  ...
  <input type="text" id="ttt_test_id" name="test_id" value="<%=O.hv("ttt.test_id")%>" size="80" readonly="readonly" />
</p>
...
<p>
  ...
  <input id="ttt_submit" name="commit" type="submit" value="Update" />&nbsp;&nbsp;&nbsp;<input type="reset"/>
<%=F.formForClose("ttts")%>

<br />

<%=W.labelLink("Show", R.resourceRecordPath("ttts", (RESTified)W.request("ttt")))%>|
