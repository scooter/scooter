...
<p>
  ...
  <input type="text" id="message_cid" name="cid" value="<%=O.hv("message.cid")%>" size="80" readonly="readonly" />
</p>


<p>
    <span class="required">*</span><%=F.label("eid")%><br />
  <input type="text" id="message_eid" name="eid" value="<%=O.hv("message.eid")%>" size="80" readonly="readonly" />
</p>
