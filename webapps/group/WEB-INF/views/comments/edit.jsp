...
<p>
  ...
  <input type="text" id="comment_cid" name="cid" value="<%=O.hv("comment.cid")%>" size="80" readonly="readonly" />
</p>


<p>
    <span class="required">*</span><%=F.label("eid")%><br />
  <input type="text" id="comment_eid" name="eid" value="<%=O.hv("comment.eid")%>" size="80" readonly="readonly" />
</p>
