...
<div id="admin">
    <div class="left">
        ...
        <%=W.labelLink("Controllers", "/admin/files/list?f=/WEB-INF/src/customerservice/controllers")%> | 
        <%=W.labelLink("Models", "/admin/files/list?f=/WEB-INF/src/customerservice/models")%> | 
